...
@FacesValidator("cpfExistente")
public class CpfExistenteValidator implements Validator {

	private VitimaBC vitimaBC = Beans.getReference(VitimaBC.class);

	private static final String KEY_ID_PESSOA = "idVitima";
	...
	public void validate(FacesContext context, UIComponent component,
		...
		try {
			...
			Long idVitima = (Long) component.getAttributes().get(KEY_ID_PESSOA);
